 ...
 * "리포트 PRO · 이용중" + 다음 결제일 · 결제금액. 하단 "요금제 업그레이드 하기"는
 * 이미 구독 중이라 상호작용 없는 정적 표시.
 */
export function ProStatusCard({ nextBilling, price }: ProStatusCardProps) {
  return (
    <div className="flex flex-col gap-5 rounded-12 border border-gray-100 p-4">
      ...
      {/* 이미 구독 중이라 상호작용 없는 정적 표시 */}
      <div className="rounded-8 bg-orange-50 py-3 text-center text-body-m-semibold text-orange-500">
        요금제 업그레이드 하기
      </div>
    </div>
  )
