...
export function MobileLayout({ children, showBottomTab = true, className }: MobileLayoutProps) {
  ...
  return (
    <div className="flex min-h-[var(--app-height,100dvh)] justify-center bg-gray-100">
      ...
      <div
        className={cn(
          'relative flex h-[var(--app-height,100dvh)] w-full max-w-[430px] flex-col overflow-hidden bg-white pt-safe-top shadow-xl',
          className,
        )}
      >
